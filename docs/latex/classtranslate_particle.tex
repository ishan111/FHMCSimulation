...
182             \textcolor{keywordflow}{throw} \hyperlink{classcustom_exception}{customException} (\textcolor{stringliteral}{"Max translation too large"});
183         \}
184     \}
185     \textcolor{keywordflow}{if} (maxD > 0) \{
186         maxD\_ = maxD;
187     \} \textcolor{keywordflow}{else} \{
188         \textcolor{keywordflow}{throw} \hyperlink{classcustom_exception}{customException} (\textcolor{stringliteral}{"Max translation must be positive"});
189     \}
190 \}
\end{DoxyCode}
