...
\begin{DoxyCode}
41 \{ \textcolor{keywordflow}{return} -lnPI\_[address]; \}
\end{DoxyCode}
...
\begin{DoxyCode}
43 \{ \textcolor{keywordflow}{return} HC\_; \}
\end{DoxyCode}
...
\begin{DoxyCode}
40 \{ \textcolor{keywordflow}{return} nSweeps\_; \}
\end{DoxyCode}
...
334     \}
335     of << \textcolor{stringliteral}{"# lnPI (bias) matrix in single row (vectorized) notation."} << std::endl;
336     of << \textcolor{stringliteral}{"# species\_total\_upper\_bound: "} << Nmax\_ << std::endl;
337     of << \textcolor{stringliteral}{"# species\_total\_lower\_bound: "} << Nmin\_ << std::endl;
338     \textcolor{keywordtype}{double} V = box\_[0]*box\_[1]*box\_[2];
339     of << \textcolor{stringliteral}{"# volume: "} << std::setprecision(15) << V << std::endl;
340     \textcolor{keywordflow}{for} (\textcolor{keywordtype}{long} \textcolor{keywordtype}{long} \textcolor{keywordtype}{int} i = 0; i < lnPI\_.size(); i += Mtot\_) \{
341         of << std::setprecision(15) << lnPI\_[i] << std::endl; \textcolor{comment}{// only print the integral states}
342     \}
343     of.close();
344 \}
\end{DoxyCode}
...
\begin{DoxyCode}
378                                           \{
379     std::ifstream infile (fileName.c\_str());
380     \textcolor{keywordflow}{if} (!infile.is\_open()) \{
381         \textcolor{keywordflow}{throw} \hyperlink{classcustom_exception}{customException}(\textcolor{stringliteral}{"Unable to read collection matrix from ASCII file "}+fileName);
382     \}
383     std::string line;
384     \textcolor{keywordtype}{int} lineIndex = 0;
385     \textcolor{keywordflow}{while}(std::getline(infile,line)) \{
386         std::stringstream lineStream(line);
387         \textcolor{comment}{// skip any header information}
388         \textcolor{keywordflow}{if} (line.compare(0,1,\textcolor{stringliteral}{"#"},0,1) != 0) \{
389             C\_[lineIndex] = atof(line.c\_str());
390             lineIndex++;
391         \}
392     \}
393     infile.close();
...
\begin{DoxyCode}
353                                            \{
354     std::ifstream infile (fileName.c\_str());
355     \textcolor{keywordflow}{if} (!infile.is\_open()) \{
356         \textcolor{keywordflow}{throw} \hyperlink{classcustom_exception}{customException}(\textcolor{stringliteral}{"Unable to read visited states matrix from ASCII file "}+
      fileName);
357     \}
358     std::string line;
359     \textcolor{keywordtype}{int} lineIndex = 0;
360     \textcolor{keywordflow}{while}(std::getline(infile,line)) \{
361         std::stringstream lineStream(line);
362         \textcolor{comment}{// skip any header information}
363         \textcolor{keywordflow}{if} (line.compare(0,1,\textcolor{stringliteral}{"#"},0,1) != 0) \{
364             HC\_[lineIndex] = atof(line.c\_str());
365             lineIndex++;
366         \}
367     \}
368     infile.close();
