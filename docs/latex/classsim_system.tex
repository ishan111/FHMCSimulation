...
452     \hyperlink{classsim_system_a46f5d3a8843821b45fd3f4d9234a177f}{walaTotalStepCounter} = 0;
453     \hyperlink{classsim_system_a1d71d1df76bba70136853e30823d2db9}{crossoverTotalStepCounter} = 0;
454     \hyperlink{classsim_system_a3ca5ff86766ab388bfd7a48605b10e17}{tmmcTotalStepCounter} = 0;
455 
456     \textcolor{keywordflow}{if} (max\_order < 1)\{
...
582         energyHistogram\_lb\_[i] = -5.0;
583         energyHistogram\_ub\_[i] = 5.0;
584         \textcolor{keywordflow}{try} \{
585             \hyperlink{classdynamic__one__dim__histogram}{dynamic\_one\_dim\_histogram} dummyHist (energyHistogram\_lb\_[i], 
      energyHistogram\_ub\_[i], energyHistDelta\_);
586             energyHistogram\_.resize(i+1, dummyHist);
587         \} \textcolor{keywordflow}{catch} (std::bad\_alloc &ba) \{
588             \textcolor{keywordflow}{throw} \hyperlink{classcustom_exception}{customException} (\textcolor{stringliteral}{"Out of memory for energy histogram for each Ntot"});
589         \}
590     \}
591     pkHistogram\_.resize(0);
592     \hyperlink{classdynamic__one__dim__histogram}{dynamic\_one\_dim\_histogram} dummyPkHist (0.0, totNBounds\_[1], 1.0);
593     \textcolor{keywordflow}{try} \{
594         std::vector < dynamic\_one\_dim\_histogram > tmp (totNBounds\_[1]-totNBounds\_[0]+1, dummyPkHist);
595         pkHistogram\_.resize(nSpecies\_, tmp);
596     \} \textcolor{keywordflow}{catch} (std::bad\_alloc &ba) \{
597         \textcolor{keywordflow}{throw} \hyperlink{classcustom_exception}{customException} (\textcolor{stringliteral}{"Out of memory for particle histogram for each Ntot"});
598     \}
599 
600     \textcolor{comment}{// initialize moments}
601     std::vector < double > lbn (6,0), ubn(6,0);
602     std::vector < long long unsigned int > nbn (6,0);
603     ubn[0] = nSpecies\_-1;
604     ubn[1] = max\_order\_;
605     ubn[2] = nSpecies\_-1;
606     ubn[3] = max\_order\_;
607     ubn[4] = max\_order\_;
608     ubn[5] = totNBounds\_[1]-totNBounds\_[0];
609 
610     nbn[0] = nSpecies\_;
611     nbn[1] = max\_order\_+1;
612     nbn[2] = nSpecies\_;
613     nbn[3] = max\_order\_+1;
614     nbn[4] = max\_order\_+1;
615     nbn[5] = size;
616 
617     \hyperlink{classhistogram}{histogram} hnn (lbn, ubn, nbn);
618     extensive\_moments\_ = hnn;
619 
620     \hyperlink{classsim_system_a2b168c89742f4d64270583e7e54b2929}{restartFromWALA} = \textcolor{keyword}{false};
621     \hyperlink{classsim_system_a0c81d3b606c070c801f8d86288e44391}{restartFromTMMC} = \textcolor{keyword}{false};
622     \hyperlink{classsim_system_afbf0b172dc35572e71ec6d27a018e2fc}{restartFromWALAFile} = \textcolor{stringliteral}{""};
623     \hyperlink{classsim_system_a5ccdad82b3767ba21b1e4b1e36362082}{restartFromTMMCFile} = \textcolor{stringliteral}{""};
624 \}
\end{DoxyCode}
...
\begin{DoxyCode}
857                                             \{
858     \textcolor{keywordflow}{if} (totN\_ >= totNBounds\_[0] && totN\_ <= totNBounds\_[1]) \{
859         \textcolor{keyword}{const} \textcolor{keywordtype}{int} address = totN\_-totNBounds\_[0];
860         energyHistogram\_lb\_[address] = std::min(energyHistogram\_lb\_[address], energy\_);
861         energyHistogram\_ub\_[address] = std::max(energyHistogram\_ub\_[address], energy\_);
862     \}
863 \}
\end{DoxyCode}
...
Referenced by perform\-G\-C\-M\-C(), and sanity\-Checks().
...
Referenced by calculate\-Bias(), agg\-Vol\-Bias3\-::make(), translate\-Particle\-::make(), delete\-Particle\-::make(), insert\-Particle\-::make(), swap\-Particles\-::make(), moves\-::make\-Move(), perform\-Crossover(), perform\-G\-C\-M\-C(), perform\-T\-M\-M\-C(), perform\-W\-A\-L\-A(), and sanity\-Checks().
...
\begin{DoxyCode}
1704                               \{
1705     \textcolor{keywordflow}{if} (\hyperlink{classsim_system_aa474a50b6353c8897331b1ab1ce53ab1}{useTMMC} == \textcolor{keyword}{true}) \{
1706         \textcolor{keywordflow}{return} \hyperlink{classsim_system_a13173f45a1e40a5f5a3552b0ebe15b54}{tmmcBias};
1707     \} \textcolor{keywordflow}{else} \{
1708         \textcolor{keywordflow}{throw} \hyperlink{classcustom_exception}{customException} (\textcolor{stringliteral}{"Not using TMMC"});
1709     \}
1710 \}
\end{DoxyCode}
...
Referenced by checkpoint\-::load(), delete\-Particle\-::make(), insert\-Particle\-::make(), moves\-::make\-Move(), perform\-Crossover(), perform\-T\-M\-M\-C(), perform\-W\-A\-L\-A(), sanity\-Checks(), set\-Barriers(), set\-Config(), set\-Moves(), and set\-Pair\-Potentials().
...
\begin{DoxyCode}
1717                               \{
1718     \textcolor{keywordflow}{if} (\hyperlink{classsim_system_aa83b00006b3919fb6e13f1bdeadece6a}{useWALA} == \textcolor{keyword}{true}) \{
1719         \textcolor{keywordflow}{return} \hyperlink{classsim_system_a6dc8d9f89dfcfa247a59bc50889c49e7}{wlBias};
1720     \} \textcolor{keywordflow}{else} \{
1721         \textcolor{keywordflow}{throw} \hyperlink{classcustom_exception}{customException} (\textcolor{stringliteral}{"Not using WALA"});
1722     \}
1723 \}
\end{DoxyCode}
...
\begin{DoxyCode}
1670                                                 \{
1671     \textcolor{keywordflow}{if} (maxSpecies\_.begin() == maxSpecies\_.end()) \{
1672             \textcolor{keywordflow}{throw} \hyperlink{classcustom_exception}{customException} (\textcolor{stringliteral}{"No species in the system, cannot report a maximum"});
1673         \}
1674         \textcolor{keywordflow}{if} (maxSpecies\_.size() <= index) \{
1675             \textcolor{keywordflow}{throw} \hyperlink{classcustom_exception}{customException} (\textcolor{stringliteral}{"System does not contain that species, cannot report a
       maximum"});
1676         \} \textcolor{keywordflow}{else}  \{
1677             \textcolor{keywordflow}{return} maxSpecies\_[index];
1678         \}
1679 \}
\end{DoxyCode}
...
\begin{DoxyCode}
1688                                                 \{
1689     \textcolor{keywordflow}{if} (minSpecies\_.begin() == minSpecies\_.end()) \{
1690             \textcolor{keywordflow}{throw} \hyperlink{classcustom_exception}{customException} (\textcolor{stringliteral}{"No species in the system, cannot report a minimum"});
1691         \}
1692         \textcolor{keywordflow}{if} (minSpecies\_.size() <= index) \{
1693             \textcolor{keywordflow}{throw} \hyperlink{classcustom_exception}{customException} (\textcolor{stringliteral}{"System does not contain that species, cannot report a
       minimum"});
1694         \} \textcolor{keywordflow}{else}  \{
1695             \textcolor{keywordflow}{return} minSpecies\_[index];
1696         \}
1697 \}
\end{DoxyCode}
...
Referenced by check\-Bounds(), agg\-Vol\-Bias3\-::make(), delete\-Particle\-::make(), translate\-Particle\-::make(), insert\-Particle\-::make(), swap\-Particles\-::make(), perform\-G\-C\-M\-C(), sanity\-Checks(), set\-Barriers(), set\-Config(), set\-Moves(), set\-Pair\-Potentials(), and sim\-System().
...
936     \textcolor{keywordflow}{for} (std::vector < dynamic\_one\_dim\_histogram >::iterator it = energyHistogram\_.begin(); it != 
      energyHistogram\_.end(); ++it) \{
937         of << it->get\_ub() << \textcolor{stringliteral}{"\(\backslash\)t"};
938     \}
939     of << std::endl;
940     \textcolor{keywordflow}{if} (normalize) \{
941         of << \textcolor{stringliteral}{"# Normalized histogram for each"} << std::endl;
942         \textcolor{keywordflow}{for} (std::vector < dynamic\_one\_dim\_histogram >::iterator it = energyHistogram\_.begin(); it != 
      energyHistogram\_.end(); ++it) \{
943             std::deque <double> h = it->get\_hist();
944             \textcolor{keywordtype}{double} sum = 0.0;
945             \textcolor{keywordflow}{for} (std::deque <double>::iterator it2 = h.begin(); it2 != h.end(); ++it2) \{
946                 sum += *it2;
947             \}
948             \textcolor{keywordflow}{for} (std::deque <double>::iterator it2 = h.begin(); it2 != h.end(); ++it2) \{
949                 of << std::setprecision(15) << *it2/sum << \textcolor{stringliteral}{"\(\backslash\)t"};
950             \}
951             of << std::endl;
952         \}
953     \} \textcolor{keywordflow}{else} \{
954         of << \textcolor{stringliteral}{"# Unnormalized histogram for each"} << std::endl;
955         \textcolor{keywordflow}{for} (std::vector < dynamic\_one\_dim\_histogram >::iterator it = energyHistogram\_.begin(); it != 
      energyHistogram\_.end(); ++it) \{
956             std::deque <double> h = it->get\_hist();
957             \textcolor{keywordflow}{for} (std::deque <double>::iterator it2 = h.begin(); it2 != h.end(); ++it2) \{
958                 of << std::setprecision(15) << *it2 << \textcolor{stringliteral}{"\(\backslash\)t"};
959             \}
960             of << std::endl;
961         \}
962     \}
...
721                         coords[2] = k;
722                         \textcolor{keywordflow}{for} (\textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{int} m = 0; m <= max\_order\_; ++m) \{
723                             coords[3] = m;
724                             \textcolor{keywordflow}{for} (\textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{int} p = 0; p <= max\_order\_; ++p) \{
725                                 coords[4] = p;
726                                 idx = extensive\_moments\_.\hyperlink{classhistogram_ae52fa58934b56e05846a66e43c3184bd}{getAddress}(coords);
727                                 of << std::setprecision(15) << h[idx] << \textcolor{stringliteral}{"\(\backslash\)t"};
728                             \}
729                         \}
730                     \}
731                 \}
...
1109             \textcolor{keywordflow}{for} (std::vector < dynamic\_one\_dim\_histogram >::iterator it = pkHistogram\_[i].begin(); it != 
      pkHistogram\_[i].end(); ++it) \{
1110                 std::deque <double> h = it->get\_hist();
1111                 \textcolor{keywordtype}{double} sum = 0.0;
1112                 \textcolor{keywordflow}{for} (std::deque <double>::iterator it2 = h.begin(); it2 != h.end(); ++it2) \{
1113                     sum += *it2;
1114                 \}
1115                 \textcolor{keywordflow}{for} (std::deque <double>::iterator it2 = h.begin(); it2 != h.end(); ++it2) \{
1116                     of << std::setprecision(15) << *it2/sum << \textcolor{stringliteral}{"\(\backslash\)t"};
1117                 \}
1118                 of << std::endl;
1119             \}
1120         \} \textcolor{keywordflow}{else} \{
1121             of << \textcolor{stringliteral}{"# Unnormalized histogram for each species index "} << std::endl;
1122             \textcolor{keywordflow}{for} (std::vector < dynamic\_one\_dim\_histogram >::iterator it = pkHistogram\_[i].begin(); it != 
      pkHistogram\_[i].end(); ++it) \{
1123                 std::deque <double> h = it->get\_hist();
1124                 \textcolor{keywordflow}{for} (std::deque <double>::iterator it2 = h.begin(); it2 != h.end(); ++it2) \{
1125                     of << std::setprecision(15) << *it2 << \textcolor{stringliteral}{"\(\backslash\)t"};
1126                 \}
1127                 of << std::endl;
1128             \}
1129         \}
...
\begin{DoxyCode}
846                                        \{
847     \textcolor{comment}{// only record if in range (removes equilibration stage to get in this range, if there was any)}
...
850         energyHistogram\_[address].record(energy\_);
851     \}
852 \}
\end{DoxyCode}
...
\begin{DoxyCode}
629                                   \{
630     \textcolor{comment}{// only record if in range (removes equilibration stage to get in this range, if there was any)}
631     \textcolor{keywordflow}{if} (totN\_ >= totNBounds\_[0] && totN\_ <= totNBounds\_[1]) \{
632         \textcolor{keywordtype}{double} val = 0.0;
633         std::vector < double > coords (6,0);
634         coords[5] = totN\_-totNBounds\_[0];
635         \textcolor{keywordflow}{for} (\textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{int} i = 0; i < nSpecies\_; ++i) \{
636             coords[0] = i;
637             \textcolor{keywordflow}{for} (\textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{int} j = 0; j <= max\_order\_; ++j) \{
638                 coords[1] = j;
639                 \textcolor{keywordflow}{for} (\textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{int} k = 0; k < nSpecies\_; ++k) \{
640                     coords[2] = k;
641                     \textcolor{keywordflow}{for} (\textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{int} m = 0; m <= max\_order\_; ++m) \{
642                         coords[3] = m;
643                         \textcolor{keywordflow}{for} (\textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{int} p = 0; p <= max\_order\_; ++p) \{
644                             coords[4] = p;
645                             val = pow(\hyperlink{classsim_system_a9eea865e6dc1cff377b1e79c4d9c23f0}{numSpecies}[i], j)*pow(\hyperlink{classsim_system_a9eea865e6dc1cff377b1e79c4d9c23f0}{numSpecies}[k], m)*pow(
      energy\_, p);
646                             extensive\_moments\_.\hyperlink{classhistogram_a665e7f6c052d4b306c6fe7d0c600f1c8}{increment} (coords, val);
647                         \}
648                     \}
649                 \}
650             \}
...
\begin{DoxyCode}
1050                                    \{
1051     \textcolor{comment}{// only record if in range (removes equilibration stage to get in this range, if there was any)}
1052     \textcolor{keywordflow}{if} (totN\_ >= totNBounds\_[0] && totN\_ <= totNBounds\_[1]) \{
1053         \textcolor{keyword}{const} \textcolor{keywordtype}{int} address = totN\_-totNBounds\_[0];
1054         \textcolor{keywordflow}{for} (\textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{int} i = 0; i < nSpecies\_; ++i) \{
1055             pkHistogram\_[i][address].record(\hyperlink{classsim_system_a9eea865e6dc1cff377b1e79c4d9c23f0}{numSpecies}[i]);
1056         \}
1057     \}
1058 \}
\end{DoxyCode}
...
\begin{DoxyCode}
868                                              \{
869     \textcolor{keywordflow}{for} (std::vector < dynamic\_one\_dim\_histogram >::iterator it = energyHistogram\_.begin(); it != 
      energyHistogram\_.end(); ++it) \{
870         \textcolor{keywordflow}{try} \{
871             it->trim\_edges();
872         \} \textcolor{keywordflow}{catch} (\hyperlink{classcustom_exception}{customException} &ce) \{
873             std::string a = \textcolor{stringliteral}{"Unable to trim edges in energyHistogram at each Ntot: "}, b = ce.
      \hyperlink{classcustom_exception_aeb6ab5848b038adfc68fde86a512f691}{what}();
874             \textcolor{keywordflow}{throw} \hyperlink{classcustom_exception}{customException} (a+b);
875         \}
876     \}
877 \}
\end{DoxyCode}
...
\begin{DoxyCode}
1063                                          \{
1064     \textcolor{keywordflow}{for} (std::vector < std::vector < dynamic\_one\_dim\_histogram > >::iterator it = pkHistogram\_.begin(); it 
      != pkHistogram\_.end(); ++it) \{
1065         \textcolor{keywordflow}{for} (std::vector < dynamic\_one\_dim\_histogram >::iterator it2 = it->begin(); it2 != it->end(); ++it2
      ) \{
1066             \textcolor{keywordflow}{try} \{
1067                 it2->trim\_edges();
1068             \} \textcolor{keywordflow}{catch} (\hyperlink{classcustom_exception}{customException} &ce) \{
1069                 \textcolor{keywordflow}{throw} \hyperlink{classcustom_exception}{customException} (\textcolor{stringliteral}{"Unable to trim edges in pkHistogram at each Ntot"});
1070             \}
1071         \}
1072     \}
1073 \}
...
1028                     energyHistogram\_[i-minBound].reinitialize(lb[i-minBound], ub[i-minBound], delta[i-
      minBound]);
1029                 \} \textcolor{keywordflow}{catch} (...) \{
1030                     \textcolor{keywordflow}{throw} \hyperlink{classcustom_exception}{customException} (\textcolor{stringliteral}{"Unable to restart energy histogram from "}+
      fileName);
1031                 \}
1032             \}
1033         \} \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (lineIndex >= 12) \{
1034             \textcolor{comment}{// histogram itself}
1035             std::deque <double> h = energyHistogram\_[lineIndex-12].get\_hist();
1036             \textcolor{keywordflow}{for} (std::deque <double>::iterator it = h.begin(); it != h.end(); ++it) \{
1037                 lineStream >> *it;
1038             \}
1039             energyHistogram\_[lineIndex-12].set\_hist(h);
1040         \}
1041         lineIndex++;
1042     \}
1043     infile.close();
...
805 
806             \hyperlink{classhistogram}{histogram} hnn (lbn, ubn, nbn);
807             extensive\_moments\_ = hnn;
808         \} \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (lineIndex >= 7) \{
809             \textcolor{comment}{// histogram itself}
810             lineStream >> dummy;
811             coords[5] = lineIndex-7;
812             \textcolor{keywordflow}{for} (\textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{int} i = 0; i < nSpecies\_; ++i) \{
813                 coords[0] = i;
814                 \textcolor{keywordflow}{for} (\textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{int} j = 0; j <= max\_order\_; ++j) \{
815                     coords[1] = j;
816                     \textcolor{keywordflow}{for} (\textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{int} k = 0; k < nSpecies\_; ++k) \{
817                         coords[2] = k;
818                         \textcolor{keywordflow}{for} (\textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{int} m = 0; m <= max\_order\_; ++m) \{
819                             coords[3] = m;
820                             \textcolor{keywordflow}{for} (\textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{int} p = 0; p <= max\_order\_; ++p) \{
821                                 coords[4] = p;
822                                 idx = extensive\_moments\_.\hyperlink{classhistogram_ae52fa58934b56e05846a66e43c3184bd}{getAddress}(coords);
...
835         \textcolor{comment}{// this checks h and ctr same size, and by extension that h from file has same size as h in system}
836         extensive\_moments\_.\hyperlink{classhistogram_aab27615593d020ca4de29c586c92af37}{set}(h, ctr);
837     \} \textcolor{keywordflow}{catch} (\hyperlink{classcustom_exception}{customException} &ce) \{
838         \textcolor{keywordflow}{throw} \hyperlink{classcustom_exception}{customException} (\textcolor{stringliteral}{"Unable to restart extMom from "}+fileName+\textcolor{stringliteral}{" : "}+ce.
      \hyperlink{classcustom_exception_aeb6ab5848b038adfc68fde86a512f691}{what}());
839     \}
840 \}
\end{DoxyCode}
...
1187                 \}
1188             \} \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (lineIndex == 10) \{
1189                 \textcolor{comment}{// upper bound}
1190                 \textcolor{keywordflow}{for} (\textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{int} i = 0; i < maxBound-minBound; ++i) \{
1191                     lineStream >> ub[i];
1192                 \}
1193                 \textcolor{comment}{// now can reinitialize the histogram}
1194                 \textcolor{keywordflow}{for} (\textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{int} i = minBound; i < maxBound; ++i) \{
1195                     \textcolor{keywordflow}{try} \{
1196                         pkHistogram\_[spec][i-minBound].reinitialize(lb[i-minBound], ub[i-minBound], delta[i
      -minBound]);
1197                     \} \textcolor{keywordflow}{catch} (...) \{
1198                         \textcolor{keywordflow}{throw} \hyperlink{classcustom_exception}{customException} (\textcolor{stringliteral}{"Unable to restart particle histogram from "}+
      fileName);
1199                     \}
1200                 \}
1201             \} \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (lineIndex >= 12) \{
1202                 \textcolor{comment}{// histogram itself}
1203                 std::deque <double> h = pkHistogram\_[spec][lineIndex-12].get\_hist();
1204                 \textcolor{keywordflow}{for} (std::deque <double>::iterator it = h.begin(); it != h.end(); ++it) \{
1205                     lineStream >> *it;
1206                 \}
1207                 pkHistogram\_[spec][lineIndex-12].set\_hist(h);
1208             \}
1209             lineIndex++;
1210         \}
1211         infile.close();
...
1638                         \textcolor{keywordflow}{return} \hyperlink{potentials_8h_ab94ab1d09e2291d03fe92a0e24a9d33b}{NUM\_INFINITY};
1639                     \}
1640                 \}
1641             \}
1642 
1643             \textcolor{comment}{// Add tail correction to potential energy but only bewteen fully inserted species}
1644 \textcolor{preprocessor}{#ifdef FLUID\_PHASE\_SIMULATIONS}
1645 \textcolor{preprocessor}{}            \textcolor{keywordflow}{if} ((\hyperlink{classsim_system_ad2e290b5963f132e6a3a56cee35c8e9f}{ppot}[spec1][spec2]->useTailCorrection) && (num2 > 0) && (num1 > 0)) \{
1646                 totU += (num1)*\hyperlink{classsim_system_ad2e290b5963f132e6a3a56cee35c8e9f}{ppot}[spec1][spec2]->tailCorrection(num2/V); \textcolor{comment}{// Never infinite}
1647             \}
1648 \textcolor{preprocessor}{#endif}
1649 \textcolor{preprocessor}{}        \}
1650     \}
1651 
1652     \textcolor{keywordflow}{if} (toggleKE\_ == \textcolor{keyword}{true}) \{
1653         \textcolor{keywordtype}{double} ns = 0.0;
1654         \textcolor{keywordflow}{for} (\textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{int} i = 0; i < nSpecies\_; ++i) \{
1655             ns += \hyperlink{classsim_system_a9eea865e6dc1cff377b1e79c4d9c23f0}{numSpecies}[i];
1656         \}
1657         totU += 1.5/beta\_*ns; \textcolor{comment}{// Only adjust for FULLY-INSERTED ATOMS}
1658     \}
1659 
1660     \textcolor{keywordflow}{return} totU;
1661 \}
\end{DoxyCode}
...
\begin{DoxyCode}
1750                                                                             \{
1751     \textcolor{comment}{// initialize the tmmc object}
1752     \textcolor{keywordflow}{try} \{
1753         \hyperlink{classsim_system_a13173f45a1e40a5f5a3552b0ebe15b54}{tmmcBias} = \textcolor{keyword}{new} \hyperlink{classtmmc}{tmmc} (totNBounds\_[1], totNBounds\_[0], Mtot, 
      \hyperlink{classsim_system_a56e284a361964d0a9ce5c45f41d56ab1}{tmmcSweepSize}, box\_);
1754     \} \textcolor{keywordflow}{catch} (\hyperlink{classcustom_exception}{customException}& ce) \{
1755         \textcolor{keywordflow}{throw} \hyperlink{classcustom_exception}{customException} (\textcolor{stringliteral}{"Cannot start TMMC biasing in system: "}+std::to\_string(*ce.
      \hyperlink{classcustom_exception_aeb6ab5848b038adfc68fde86a512f691}{what}()));
1756     \}
1757 
1758     \hyperlink{classsim_system_aa474a50b6353c8897331b1ab1ce53ab1}{useTMMC} = \textcolor{keyword}{true};
1759 \}
\end{DoxyCode}
...
\begin{DoxyCode}
1733                                                                                            \{
1734     \textcolor{comment}{// initialize the wala object}
1735     \textcolor{keywordflow}{try} \{
1736         \hyperlink{classsim_system_a6dc8d9f89dfcfa247a59bc50889c49e7}{wlBias} = \textcolor{keyword}{new} \hyperlink{classwala}{wala} (lnF, g, s, totNBounds\_[1], totNBounds\_[0], Mtot, box\_);
1737     \} \textcolor{keywordflow}{catch} (\hyperlink{classcustom_exception}{customException}& ce) \{
1738         \textcolor{keywordflow}{throw} \hyperlink{classcustom_exception}{customException} (\textcolor{stringliteral}{"Cannot start Wang-Landau biasing in system: "}+std::to\_string
      (*ce.\hyperlink{classcustom_exception_aeb6ab5848b038adfc68fde86a512f691}{what}()));
1739     \}
1740 
1741     \hyperlink{classsim_system_aa83b00006b3919fb6e13f1bdeadece6a}{useWALA} = \textcolor{keyword}{true};
1742 \}
\end{DoxyCode}
...
\hypertarget{classsim_system_a1d71d1df76bba70136853e30823d2db9}{\index{sim\-System@{sim\-System}!crossover\-Total\-Step\-Counter@{crossover\-Total\-Step\-Counter}}
\index{crossover\-Total\-Step\-Counter@{crossover\-Total\-Step\-Counter}!simSystem@{sim\-System}}
...
\hypertarget{classsim_system_aa83fc40dca4aa56d890dbc978da1ea4e}{\index{sim\-System@{sim\-System}!gcmc\-Eq\-Steps@{gcmc\-Eq\-Steps}}
\index{gcmc\-Eq\-Steps@{gcmc\-Eq\-Steps}!simSystem@{sim\-System}}
...
In the case of unbiased G\-C\-M\-C, number of equilibration steps to perform. 
...
\hypertarget{classsim_system_ae477ed10d350665f6065774a12f884c8}{\index{sim\-System@{sim\-System}!gcmc\-Pr\-Steps@{gcmc\-Pr\-Steps}}
\index{gcmc\-Pr\-Steps@{gcmc\-Pr\-Steps}!simSystem@{sim\-System}}
...
\hypertarget{classsim_system_ad899e42a50a3ae94ac18663bca5bd8b3}{\index{sim\-System@{sim\-System}!gcmc\-Snap\-Freq@{gcmc\-Snap\-Freq}}
\index{gcmc\-Snap\-Freq@{gcmc\-Snap\-Freq}!simSystem@{sim\-System}}
...
\hypertarget{classsim_system_a91d057904fa4d57543fef4133294899f}{\index{sim\-System@{sim\-System}!gcmc\-Thermo\-Freq@{gcmc\-Thermo\-Freq}}
\index{gcmc\-Thermo\-Freq@{gcmc\-Thermo\-Freq}!simSystem@{sim\-System}}
...
In the case of unbiased G\-C\-M\-C, frequency with which to record thermo properties. 
...
\hypertarget{classsim_system_a3ca5ff86766ab388bfd7a48605b10e17}{\index{sim\-System@{sim\-System}!tmmc\-Total\-Step\-Counter@{tmmc\-Total\-Step\-Counter}}
\index{tmmc\-Total\-Step\-Counter@{tmmc\-Total\-Step\-Counter}!simSystem@{sim\-System}}
...
\hypertarget{classsim_system_a46f5d3a8843821b45fd3f4d9234a177f}{\index{sim\-System@{sim\-System}!wala\-Total\-Step\-Counter@{wala\-Total\-Step\-Counter}}
\index{wala\-Total\-Step\-Counter@{wala\-Total\-Step\-Counter}!simSystem@{sim\-System}}
...
Referenced by checkpoint\-::dump(), checkpoint\-::load(), perform\-Crossover(), perform\-T\-M\-M\-C(), perform\-W\-A\-L\-A(), and sim\-System().
