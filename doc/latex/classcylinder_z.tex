...
470         \textcolor{keywordflow}{throw} \hyperlink{classcustom_exception}{customException} (\textcolor{stringliteral}{"cylinderZ must have range width >= 0"});
471     \}
472     \textcolor{keywordflow}{if} (eps < 0) \{
473         \textcolor{keywordflow}{throw} \hyperlink{classcustom_exception}{customException} (\textcolor{stringliteral}{"cylinderZ must have eps >= 0"});
474     \}
