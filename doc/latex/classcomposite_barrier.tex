...
\begin{DoxyCode}
784                                      \{
785     \textcolor{keywordflow}{if} (sysBarriers\_.begin() != sysBarriers\_.end()) \{
786         \textcolor{keywordflow}{for} (\textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{int} i = 0; i < sysBarriers\_.size(); ++i) \{
787             \textcolor{keyword}{delete} sysBarriers\_[i];
788         \}
789         sysBarriers\_.clear();
790     \}
791 \}
\end{DoxyCode}
...
724                                                                                                            
                                                          \{
725     \textcolor{keywordflow}{if} (sysBarriers\_.begin() == sysBarriers\_.end()) \{
726         \textcolor{keywordflow}{try} \{
727             sysBarriers\_.resize(1);
728         \} \textcolor{keywordflow}{catch} (std::bad\_alloc &ba) \{
729             \textcolor{keywordflow}{throw} \hyperlink{classcustom_exception}{customException} (\textcolor{stringliteral}{"Unable to allocate space for a new barrier"});
730         \}
731     \} \textcolor{keywordflow}{else} \{
732         \textcolor{keywordflow}{try} \{
733             sysBarriers\_.resize(sysBarriers\_.size()+1);
734         \} \textcolor{keywordflow}{catch} (std::bad\_alloc &ba) \{
735             \textcolor{keywordflow}{throw} \hyperlink{classcustom_exception}{customException} (\textcolor{stringliteral}{"Unable to allocate space for a new barrier"});
736         \}
737     \}
738     \textcolor{keywordflow}{try} \{
739         sysBarriers\_[sysBarriers\_.size()-1] = \textcolor{keyword}{new} \hyperlink{classcylinder_z}{cylinderZ} (x, y, radius, width, sigma, eps, M);
740     \} \textcolor{keywordflow}{catch} (\hyperlink{classcustom_exception}{customException} &ce) \{
741         \textcolor{keywordflow}{throw} \hyperlink{classcustom_exception}{customException} (\textcolor{stringliteral}{"Cannot add cylinderZ to composite barrier: "}+std::to\_string(
...
\begin{DoxyCode}
661                                                                                                       \{
662     \textcolor{keywordflow}{if} (sysBarriers\_.begin() == sysBarriers\_.end()) \{
663         \textcolor{keywordflow}{try} \{
664             sysBarriers\_.resize(1);
665         \} \textcolor{keywordflow}{catch} (std::bad\_alloc &ba) \{
666             \textcolor{keywordflow}{throw} \hyperlink{classcustom_exception}{customException} (\textcolor{stringliteral}{"Unable to allocate space for a new barrier"});
667         \}
668     \} \textcolor{keywordflow}{else} \{
669         \textcolor{keywordflow}{try} \{
670             sysBarriers\_.resize(sysBarriers\_.size()+1);
671         \} \textcolor{keywordflow}{catch} (std::bad\_alloc &ba) \{
672             \textcolor{keywordflow}{throw} \hyperlink{classcustom_exception}{customException} (\textcolor{stringliteral}{"Unable to allocate space for a new barrier"});
673         \}
674     \}
675     \textcolor{keywordflow}{try} \{
676         sysBarriers\_[sysBarriers\_.size()-1] = \textcolor{keyword}{new} \hyperlink{classhard_wall_z}{hardWallZ} (lb, ub, sigma, M);
677     \} \textcolor{keywordflow}{catch} (\hyperlink{classcustom_exception}{customException} &ce) \{
678         \textcolor{keywordflow}{throw} \hyperlink{classcustom_exception}{customException} (\textcolor{stringliteral}{"Cannot add hardWallZ to composite barrier: "}+std::to\_string(
      *ce.\hyperlink{classcustom_exception_aeb6ab5848b038adfc68fde86a512f691}{what}()));
679     \}
680 \}
\end{DoxyCode}
...
760                                                                                                            
                                            ...
                                            \{
761     \textcolor{keywordflow}{if} (sysBarriers\_.begin() == sysBarriers\_.end()) \{
762         \textcolor{keywordflow}{try} \{
763             sysBarriers\_.resize(1);
764         \} \textcolor{keywordflow}{catch} (std::bad\_alloc &ba) \{
765             \textcolor{keywordflow}{throw} \hyperlink{classcustom_exception}{customException} (\textcolor{stringliteral}{"Unable to allocate space for a new barrier"});
766         \}
767     \} \textcolor{keywordflow}{else} \{
768         \textcolor{keywordflow}{try} \{
769             sysBarriers\_.resize(sysBarriers\_.size()+1);
770         \} \textcolor{keywordflow}{catch} (std::bad\_alloc &ba) \{
771             \textcolor{keywordflow}{throw} \hyperlink{classcustom_exception}{customException} (\textcolor{stringliteral}{"Unable to allocate space for a new barrier"});
772         \}
773     \}
774     \textcolor{keywordflow}{try} \{
775         sysBarriers\_[sysBarriers\_.size()-1] = \textcolor{keyword}{new} \hyperlink{classright_triangle_x_z}{rightTriangleXZ} (width, theta, lamW, eps, 
      sigma, sep, offset, box, zbase, top, M);
776     \} \textcolor{keywordflow}{catch} (\hyperlink{classcustom_exception}{customException} &ce) \{
777         \textcolor{keywordflow}{throw} \hyperlink{classcustom_exception}{customException} (\textcolor{stringliteral}{"Cannot add rightTriangleXZ to composite barrier: "}+
      std::to\_string(*ce.\hyperlink{classcustom_exception_aeb6ab5848b038adfc68fde86a512f691}{what}()));
778     \}
779 \}
\end{DoxyCode}
...
692                                                                                                            
                                             \{
693     \textcolor{keywordflow}{if} (sysBarriers\_.begin() == sysBarriers\_.end()) \{
694         \textcolor{keywordflow}{try} \{
695             sysBarriers\_.resize(1);
696         \} \textcolor{keywordflow}{catch} (std::bad\_alloc &ba) \{
697             \textcolor{keywordflow}{throw} \hyperlink{classcustom_exception}{customException} (\textcolor{stringliteral}{"Unable to allocate space for a new barrier"});
698         \}
699     \} \textcolor{keywordflow}{else} \{
700         \textcolor{keywordflow}{try} \{
701             sysBarriers\_.resize(sysBarriers\_.size()+1);
702         \} \textcolor{keywordflow}{catch} (std::bad\_alloc &ba) \{
703             \textcolor{keywordflow}{throw} \hyperlink{classcustom_exception}{customException} (\textcolor{stringliteral}{"Unable to allocate space for a new barrier"});
704         \}
705     \}
706     \textcolor{keywordflow}{try} \{
707         sysBarriers\_[sysBarriers\_.size()-1] = \textcolor{keyword}{new} \hyperlink{classsquare_well_wall_z}{squareWellWallZ} (lb, ub, sigma, range, eps
      , M);
708     \} \textcolor{keywordflow}{catch} (\hyperlink{classcustom_exception}{customException} &ce) \{
709         \textcolor{keywordflow}{throw} \hyperlink{classcustom_exception}{customException} (\textcolor{stringliteral}{"Cannot add squareWellWallZ to composite barrier: "}+
      std::to\_string(*ce.\hyperlink{classcustom_exception_aeb6ab5848b038adfc68fde86a512f691}{what}()));
710     \}
711 \}
\end{DoxyCode}
...
\begin{DoxyCode}
814                                                                                 \{
815     \textcolor{keywordtype}{double} U = 0.0;
816     \textcolor{keywordflow}{for} (std::vector < barrier* >::iterator it = sysBarriers\_.begin(); it != sysBarriers\_.end(); ++it) \{
817         \textcolor{keywordtype}{double} dU = (*it)->energy (a1, box);
818         \textcolor{keywordflow}{if} (dU < \hyperlink{potentials_8h_ab94ab1d09e2291d03fe92a0e24a9d33b}{NUM\_INFINITY}) \{
819             U += dU;
820         \} \textcolor{keywordflow}{else} \{
821             \textcolor{keywordflow}{return} \hyperlink{potentials_8h_ab94ab1d09e2291d03fe92a0e24a9d33b}{NUM\_INFINITY};
822         \}
823     \}
824     \textcolor{keywordflow}{return} U;
825 \}
\end{DoxyCode}
