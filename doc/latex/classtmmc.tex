...
const \hyperlink{bias_8h_a1ceb524363fcb94da0c64d297ea27438}{\-\_\-\-\_\-\-B\-I\-A\-S\-\_\-\-I\-N\-T\-\_\-\-T\-Y\-P\-E\-\_\-\-\_\-} \hyperlink{classtmmc_a62acddd907713a4b2a8a142b209ddaad}{get\-Address} (const int Nval, const int Mval)
...
References \-\_\-\-\_\-\-B\-I\-A\-S\-\_\-\-I\-N\-T\-\_\-\-T\-Y\-P\-E\-\_\-\-\_\-, and get\-Transition\-Address().
...
264     \textcolor{keywordflow}{for} (\hyperlink{bias_8h_a1ceb524363fcb94da0c64d297ea27438}{\_\_BIAS\_INT\_TYPE\_\_} i = 0; i < (Nmax\_ - Nmin\_); ++i) \{ \textcolor{comment}{// don't calculate the last
       N = Nmax when M > 0, stops initially at N = Nmax, M = 0}
265         nStartForward = Nmin\_+i;
266         \textcolor{keywordflow}{for} (\hyperlink{bias_8h_a1ceb524363fcb94da0c64d297ea27438}{\_\_BIAS\_INT\_TYPE\_\_} j = 0; j < Mtot\_; ++j) \{
267             mStartForward = j;
268             \textcolor{keywordflow}{if} (j == Mtot\_-1) \{
...
280 
281             address1 = \hyperlink{classtmmc_ae296df3336ebf0fa1db7c34972c544eb}{getTransitionAddress}(nStartForward, nEndForward, mStartForward, 
      mEndForward);
282             address2 = \hyperlink{classtmmc_ae296df3336ebf0fa1db7c34972c544eb}{getTransitionAddress}(nStartBackward, nEndBackward, 
      mStartBackward, mEndBackward);
283 
284             \textcolor{keywordflow}{if} (!(P\_[address1] > 0) || !(P\_[address2] > 0)) \{
285                 \textcolor{keywordflow}{throw} \hyperlink{classcustom_exception}{customException} (\textcolor{stringliteral}{"Cannot compute TMMC macrostate distribution because
...
286             \}
287             lnPI\_[counter+1] = lnPI\_[counter] + log(P\_[address1]/P\_[address2]); \textcolor{comment}{// this is why P\_ cannot be
       zero}
288             counter++;
289         \}
290     \}
...
102     \textcolor{keywordflow}{for} (\hyperlink{bias_8h_a1ceb524363fcb94da0c64d297ea27438}{\_\_BIAS\_INT\_TYPE\_\_} i = 0; i < endPoint; i += 3) \{
...
95 \}
\end{DoxyCode}
\hypertarget{classtmmc_a62acddd907713a4b2a8a142b209ddaad}{\index{tmmc@{tmmc}!get\-Address@{get\-Address}}
\index{get\-Address@{get\-Address}!tmmc@{tmmc}}
\subsubsection[{get\-Address}]{\setlength{\rightskip}{0pt plus 5cm}const {\bf \-\_\-\-\_\-\-B\-I\-A\-S\-\_\-\-I\-N\-T\-\_\-\-T\-Y\-P\-E\-\_\-\-\_\-} tmmc\-::get\-Address (
\begin{DoxyParamCaption}
\item[{const int}]{Nval, }
\item[{const int}]{Mval}
\end{DoxyParamCaption}
)}}\label{classtmmc_a62acddd907713a4b2a8a142b209ddaad}
...
\begin{DoxyCode}
48 \{ \textcolor{keywordflow}{return} -lnPI\_[address]; \}
\end{DoxyCode}
...
Definition at line 49 of file bias.\-h.
...
\begin{DoxyCode}
50 \{ \textcolor{keywordflow}{return} HC\_; \}
\end{DoxyCode}
\hypertarget{classtmmc_ae296df3336ebf0fa1db7c34972c544eb}{\index{tmmc@{tmmc}!get\-Transition\-Address@{get\-Transition\-Address}}
\index{get\-Transition\-Address@{get\-Transition\-Address}!tmmc@{tmmc}}
\subsubsection[{get\-Transition\-Address}]{\setlength{\rightskip}{0pt plus 5cm}const {\bf \-\_\-\-\_\-\-B\-I\-A\-S\-\_\-\-I\-N\-T\-\_\-\-T\-Y\-P\-E\-\_\-\-\_\-} tmmc\-::get\-Transition\-Address (
\begin{DoxyParamCaption}
...
\item[{const int}]{Mend}
\end{DoxyParamCaption}
)}}\label{classtmmc_ae296df3336ebf0fa1db7c34972c544eb}
...
187         \}
188         \hyperlink{bias_8h_a1ceb524363fcb94da0c64d297ea27438}{\_\_BIAS\_INT\_TYPE\_\_} x = Nstart - Nmin\_;
...
Definition at line 47 of file bias.\-h.
...
\begin{DoxyCode}
47 \{ \textcolor{keywordflow}{return} nSweeps\_; \}
\end{DoxyCode}
...
Definition at line 302 of file bias.\-cpp.
...
Definition at line 457 of file bias.\-cpp.
...
\begin{DoxyCode}
457                                           \{
458 \textcolor{preprocessor}{#ifdef NETCDF\_CAPABLE}
459 \textcolor{preprocessor}{}    \textcolor{keywordflow}{try} \{
460         NcFile dataFile (fileName.c\_str(), NcFile::read);
461         NcVar C\_data = dataFile.getVar(\textcolor{stringliteral}{"C"});
462         \textcolor{keywordflow}{if} (C\_data.isNull()) \textcolor{keywordflow}{throw} \hyperlink{classcustom_exception}{customException}(\textcolor{stringliteral}{"Collection matrix was empty, cannot read
       from "}+fileName);
463         C\_data.getVar(&C\_[0]);
464     \} \textcolor{keywordflow}{catch} (NcException ioe) \{
465         \textcolor{keywordflow}{throw} \hyperlink{classcustom_exception}{customException} (\textcolor{stringliteral}{"Unable to read collection matrix from netCDF file "}+fileName
      );
466     \}
467 \textcolor{preprocessor}{#else}
468 \textcolor{preprocessor}{}    std::ifstream infile (fileName.c\_str());
469     \textcolor{keywordflow}{if} (!infile.is\_open()) \{
470         \textcolor{keywordflow}{throw} \hyperlink{classcustom_exception}{customException}(\textcolor{stringliteral}{"Unable to read collection matrix from ASCII file "}+fileName);
471     \}
472     std::string line;
473     \textcolor{keywordtype}{int} lineIndex = 0;
474     \textcolor{keywordflow}{while}(std::getline(infile,line)) \{
475         std::stringstream lineStream(line);
476         \textcolor{comment}{// skip any header information}
477         \textcolor{keywordflow}{if} (line.compare(0,1,\textcolor{stringliteral}{"#"},0,1) != 0) \{
478             C\_[lineIndex] = atof(line.c\_str());
479             lineIndex++;
480         \}
481     \}
482     infile.close();
483 \textcolor{preprocessor}{#endif}
484 \textcolor{preprocessor}{}\}
\end{DoxyCode}
...
\begin{DoxyCode}
421                                            \{
422 \textcolor{preprocessor}{#ifdef NETCDF\_CAPABLE}
423 \textcolor{preprocessor}{}    \textcolor{keywordflow}{try} \{
424         NcFile dataFile (fileName.c\_str(), NcFile::read);
425         NcVar HC\_data = dataFile.getVar(\textcolor{stringliteral}{"HC"});
426         \textcolor{keywordflow}{if} (HC\_data.isNull()) \textcolor{keywordflow}{throw} \hyperlink{classcustom_exception}{customException}(\textcolor{stringliteral}{"Visited states matrix was empty, cannot
       read from "}+fileName);
427         HC\_data.getVar(&HC\_[0]);
428     \} \textcolor{keywordflow}{catch} (NcException ioe) \{
429         \textcolor{keywordflow}{throw} \hyperlink{classcustom_exception}{customException} (\textcolor{stringliteral}{"Unable to read visited states matrix from netCDF file "}+
      fileName);
430     \}
431 \textcolor{preprocessor}{#else}
432 \textcolor{preprocessor}{}    std::ifstream infile (fileName.c\_str());
433     \textcolor{keywordflow}{if} (!infile.is\_open()) \{
434         \textcolor{keywordflow}{throw} \hyperlink{classcustom_exception}{customException}(\textcolor{stringliteral}{"Unable to read visited states matrix from ASCII file "}+
      fileName);
435     \}
436     std::string line;
437     \textcolor{keywordtype}{int} lineIndex = 0;
438     \textcolor{keywordflow}{while}(std::getline(infile,line)) \{
439         std::stringstream lineStream(line);
440         \textcolor{comment}{// skip any header information}
441         \textcolor{keywordflow}{if} (line.compare(0,1,\textcolor{stringliteral}{"#"},0,1) != 0) \{
442             HC\_[lineIndex] = atof(line.c\_str());
443             lineIndex++;
444         \}
445     \}
446     infile.close();
